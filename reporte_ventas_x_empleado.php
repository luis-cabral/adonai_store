...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $total_pages = $Ventas->getTotalItemsVentasReporteEmpleado($iempl, $iprod, $iclie);
    $result = $Ventas->getVentasReporteEmpleado($iempl, $iprod, $iclie, $page, $num_results_on_page);
};
?>
        ...
        <table class="table table-striped table-responsive caption-top mb-3">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="EstadoDropdown">
                        <li><a class="dropdown-item" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                            endif; ?>pn=<?php echo $page ?>&nrop=5&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>">5</a></li>
                        <li><a class="dropdown-item" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                            endif; ?>pn=<?php echo $page ?>&nrop=10&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>">10</a></li>
                        <li><a class="dropdown-item" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                            endif; ?>pn=<?php echo $page ?>&nrop=15&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>">15</a></li>
                    </ul>
                </div>
            </caption>
            <thead class="table-principal">
                <tr>
                    ...
                    <th class="text-center">
                        ...
                        else: echo "<a href='reporte_ventas_x_empleado.php?e=$estado&pn=$page&nrop=$num_results_on_page&iprod=$iprod&iempl=$iempl' class='btn btn-link btn-sm'>Cliente <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-arrow-bar-down' viewBox='0 0 16 16'><path fill-rule='evenodd' d='M1 3.5a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 0 1h-13a.5.5 0 0 1-.5-.5M8 6a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 0 1 .708-.708L7.5 12.293V6.5A.5.5 0 0 1 8 6'/></svg></a>";
                        endif; ?>
                    </th>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        <td>
                            <a href="reporte_ventas_x_empleado.php?e=<?php echo $estado; ?>&pn=<?php echo $page ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $row['id_producto'] ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>" class="btn btn-link btn-sm">
                        ...
                        <td>
                            <a href="reporte_ventas_x_empleado.php?e=<?php echo $estado; ?>&pn=<?php echo $page ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $row['id_cliente'] ?>&iempl=<?php echo $iempl ?>" class="btn btn-link btn-sm">
                                <?php echo $row['cedula']; ?> - <?php echo $row['nombre']; ?> <?php echo $row['apellido']; ?>
                            </a>
                        </td>
                        <?php if ($_SESSION['usuario']["rol"] == 1): ?>
                            <td>
                                <a href="reporte_ventas_x_empleado.php?e=<?php echo $estado; ?>&pn=<?php echo $page ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $row['id_empleado'] ?>" class="btn btn-link btn-sm">
            ...
            <nav aria-label="Navegación de la página" class="py-1">
                <ul class="pagination pagination-sm justify-content-center">
                    <?php if ($page > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href='reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                        endif; ?>pn=<?php echo $page - 1 ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>'><span aria-hidden="true">&laquo;</span></a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($page > 3): ?>
                        <li class="page-item">
                            <a class="page-link" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                        endif; ?>pn=1&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>">1</a>
                        </li>
                    ...
                    <?php if ($page - 2 > 0): ?>
                        <li class="page-item">
                            <a class="page-link" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                        endif; ?>pn=<?php echo $page - 2 ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>"><?php echo $page - 2 ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if ($page - 1 > 0): ?>
                        <li class="page-item">
                            <a class="page-link" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                        endif; ?>pn=<?php echo $page - 1 ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>"><?php echo $page - 1 ?></a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($page < ceil($total_pages / $num_results_on_page) - 2): ?>
                        ...
                        <li class="page-item">
                            <a class="page-link" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                        endif; ?>pn=<?php echo ceil($total_pages / $num_results_on_page) ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
                        <li class="page-item">
                            <a class="page-link" href="reporte_ventas_x_empleado.php?<?php if ($estado != "TODO"): echo "e=$estado&";
                                                                                        endif; ?>pn=<?php echo $page + 1 ?>&nrop=<?php echo $num_results_on_page ?>&iprod=<?php echo $iprod ?>&iclie=<?php echo $iclie ?>&iempl=<?php echo $iempl ?>"><span aria-hidden="true">&raquo;</span></a>
                        </li>
                    <?php endif; ?>
                </ul>
            </nav>

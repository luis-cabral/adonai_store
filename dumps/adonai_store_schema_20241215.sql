...
--
-- Servidor: localhost
-- Tiempo de generación: 13-12-2024 a las 18:52:52
...
(1, '5959208', '5959208-5', 'Luis Alberto', 'Cabral Samudio', 'Guido Spano 3050', '0971667440', 'ACTIVO', '2024-12-13 10:52:37', '2024-12-13 10:52:37', NULL),
...
(31, 22, 200000, 5, 1000000, 'ACTIVO', '2024-12-13 09:55:08', '2024-12-13 09:55:08', NULL);
...
(1, 'Camisas básicas', 10, 1, 'ACTIVO', NULL, NULL, '2024-12-13 14:16:58'),
...
--
-- Truncar tablas antes de insertar `puntos_venta`
--
...
--
-- Truncar tablas antes de insertar `rol_ventanas`
--

TRUNCATE TABLE `rol_ventanas`;
--
...
('gestion_clientes.php', 2, 'ACTIVO', '2024-12-13 11:06:18', '2024-12-13 11:06:18', NULL),
...
('gestion_usuarios.php', 1, '', '2024-12-13 14:45:11', '2024-12-11 16:45:45', '2024-12-13 14:45:11');
...
(5, 'Luis', 'Cabral', 'luis.a.cabral1@gmail.com', '$2y$10$VXjtmk2NRo8Sr4m8J3.7vuKzzqsz.hTMqXOmjrvJM738WENDzJxjy', 2, 'ACTIVO', NULL, NULL, '2024-12-12 18:08:27'),
(6, 'Adonai', 'Store', 'adonaiStore@gmail.com', '$2y$10$liYmAjTuUymmKotMJqlaMezs1yQNR0fWjuMHYeTy2TaIss0IfsUN2', 1, 'ACTIVO', NULL, NULL, NULL),
(7, 'CARLOS CELSO ROBERTO', 'RADICE MORALES', 'cradice@gmial.com', '$2y$10$kDgD2fVZmFen4FV1Yagby.zizfnyAorAFHj6h6NEEZIYUE9UzBqE.', 2, 'ACTIVO', '2024-12-13 13:31:11', '2024-12-13 13:31:11', '2024-12-13 13:46:07');
...
--
-- Truncar tablas antes de insertar `ventanas`
--

TRUNCATE TABLE `ventanas`;
--
...
ALTER TABLE `usuarios`
  ADD CONSTRAINT `role_usua_fk` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id_rol`) ON DELETE RESTRICT ON UPDATE RESTRICT;
